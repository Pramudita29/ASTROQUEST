    ...
    return (
        <BackgroundLayout>
            ...
            <div className="border border-white rounded-2xl w-full max-w-2xl px-10 py-10 mt-10">
                ...
                <p className="text-white text-2xl font-['Space_Grotesk'] mb-10 text-center">Log in to explore the Universe</p>
                <form className="space-y-6">
                    ...
                    <div className="flex justify-center">
                        <button
                            type="submit"
                            className="mt-6 w-[200px] h-[60px] bg-[#FFD369] rounded-full text-[#111A42] text-2xl font-['Inknut_Antiqua']"
                        >
                            Sign In
                        </button>
                    </div>
